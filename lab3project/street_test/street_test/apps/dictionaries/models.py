...
class DictStreetDocuments(models.Model):
    name = models.CharField('Тип документу',max_length = 100, blank=True, null=True)
    description = models.CharField('Опис документу',max_length = 100, blank=True, null=True)
