...
#include "../../timers/customlistwidget.h"
...
QT_MOC_LITERAL(1, 17, 17), // "currentRowRemoved"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "CustomListWidget\0currentRowRemoved\0"
};
...
void CustomListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->currentRowRemoved(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomListWidget::currentRowRemoved)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomListWidget::currentRowRemoved()
{
